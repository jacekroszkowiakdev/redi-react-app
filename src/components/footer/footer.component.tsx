        ...
        return (
            <footer>
                ...
                <div className="footer-ribbon">
                    <div className="footer-ribbon-name">
                        <span>
                            © &copy; {year} {companyName}
                        </span>
                    </div>
                    <div className="footer-ribbon-nav-1">
                        <a
                            href="../index.html"
                            target="_parent"
                    ...
                    <div className="footer-ribbon-nav-2">
                        <a
                            href="contact.html"
                            target="_parent"
                            className="hover:text-gray-200"
                    ...
                    <div className="footer-ribbon-nav-3">
                        <a
                            href="../index.html"
                            target="_parent"
                            className="hover:text-gray-200"
                    ...
                    <div className="footer-ribbon-nav-4">
                        <a
                            href="about.html"
                            target="_parent"
                            className="hover:text-gray-200"
